...
from Ascon_XOF_round_4_preimage_for_painting import initial_state_output,intermediate_states_output
...
latex_code = ''
row_num = 0
latex_code += generate_line_tikz_code(initial_state_output[0], initial_state_output[1],add_bit=[len(r),len(b)],slice_number=last_slice, index_row=initial_state_output[2], name='$M_2: $'+initial_state_output[3], first_slice=0, last_slice=last_slice)
...
with open(f"..\\tex\\4-round-Ascon-XOF-0-64.tex", "w", encoding="utf-8") as f:
