...
def write_row(state, row, name):
    A = [[[0 for z in range(32)] for y in range(5)] for x in range(5)]  # Color values: 0-2
    B = [[[0 for z in range(32)] for y in range(5)] for x in range(5)]
    for x in range(5):
        for y in range(5):
            for z in range(32):
...
def write_row_C(state, row, theta_vars, linear_cancel, name):
    A = [[0 for z in range(32)] for x in range(5)]  # Color values: 0-2
    B = [[0 for z in range(32)] for x in range(5)]
    for x in range(5):
        for z in range(32):
...
def write_Ascon_P(state, slice_number, linear_cancel, row, vars, name):
    A = [[0 for z in range(32)] for x in range(5)]  # Color values: 0-2
    B = [[None for z in range(32)] for x in range(5)]
    for x in range(5):
